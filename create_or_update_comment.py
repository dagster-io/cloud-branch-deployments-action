...
SUCCESS_IMAGE = "![daggy](https://raw.githubusercontent.com/dagster-io/dagster/9842ba843d281146ab0242be96e2c6301f5e42c9/js_modules/dagit/packages/app/public/favicon-run-success.svg | width=100 height=100)"
...
| ------------- | --------------- | ----------------- |
| `my_location` | {SUCCESS_IMAGE} | {deployment_url}  |
"""
